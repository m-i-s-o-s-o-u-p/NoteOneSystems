...
# ==========================================
# 3. 📝 編集部（市場調査課 ➔ 記事制作課 ➔ 広報課 ➔ 品質管理課）
# ==========================================
elif menu == "📝 編集部":
    st.markdown("<div class='main-header'>📝 編集部</div>", unsafe_allow_html=True)
    st.markdown("<div class='sub-header'>市場調査課、記事制作課、広報課、品質管理課が一体となり高品質な有料記事を創出します</div>", unsafe_allow_html=True)
