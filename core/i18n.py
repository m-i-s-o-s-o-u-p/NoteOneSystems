...
MESSAGES = {
    "ja": {
        ...
        "cc_price_label": "価格方針",
        "cc_price_opt_300": "基本価格（300円・衝動買い推奨）",
        "cc_price_opt_500": "発展価格（500円・ワンコイン）",
        "cc_price_opt_prem": "高付加価値（980円〜）",
        "cc_price_opt_auto": "自動提案（アナリスト最適化・基本300円）",
    ...
    "en": {
        ...
        "cc_price_opt_300": "Base Standard (300 JPY - Impulse Buy)",
        "cc_price_opt_500": "Growth Tier (500 JPY)",
        "cc_price_opt_prem": "Premium Tier (980+ JPY)",
        "cc_price_opt_auto": "Auto-Optimized (AI Recommended - Base 300 JPY)",
